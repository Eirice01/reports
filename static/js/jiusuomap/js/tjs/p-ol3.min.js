...
goog.global = this, goog.global.CLOSURE_UNCOMPILED_DEFINES, goog.global.CLOSURE_DEFINES, goog.isDef = function (t) {
  ...
  if (goog.DEPENDENCIES_ENABLED) {
    for (var n, g, s = t.replace(/\\/g, "/"), i = goog.dependencies_, a = 0; n = o[a]; a++) i.nameToPath[n] = s, i.pathIsModule[s] = !!r;
    for (var l = 0; g = e[l]; l++) s in i.requires || (i.requires[s] = {}), i.requires[s][g] = !0
  }
  ...
  var s = goog.wrapModule_(t, n), i = goog.IS_OLD_IE_;
  i ? goog.queuedModules_.push(s) : r(t, s), goog.dependencies_.written[t] = !0
  ...
  if (goog.inHtmlDocument_()) {
    ...
    } else e.write('<script type="text/javascript" src="' + '"></script>'); else e.write('<script type="text/javascript">' + o + "</script>");
    return !0
  }
  return !1
  ...
  goog.moduleLoaderState_ = null;
  for (var i = !1, g = 0; g < o.length; g++) {
    var n = o[g];
    if (!n) throw goog.moduleLoaderState_ = s, Error("Undefined script input");
    r.pathIsModule[n] ? (i = !0, goog.importModule_(goog.basePath + n)) : goog.importScript_(goog.basePath + n)
  }
...
}, goog.findBasePath_(), goog.global.CLOSURE_NO_DEPS || goog.importScript_('')), goog.typeOf = function (t) {
  var o = typeof t;
  if ("object" == o) {
    if (!t) return "null";
  ...
  for (var n = Array.prototype.slice.call(arguments, 2), g = !1, s = t.constructor; s; s = s.superClass_ && s.superClass_.constructor) if (s.prototype[o] === r) g = !0; else if (g) return s.prototype[o].apply(t, n);
  ...
  if (e && (t = goog.string.unescapeEntities(t)), r && t.length > o) {
    ...
    var s = Math.floor(o / 2), i = t.length - s;
    s += o % 2, t = t.substring(0, s) + "..." + t.substring(i)
  }
  ...
  for (var e = 0, r = goog.string.trim(String(t)).split("."), n = goog.string.trim(String(o)).split("."), g = Math.max(r.length, n.length), s = 0; 0 == e && g > s; s++) {
    var i = r[s] || "", a = n[s] || "", l = new RegExp("(\\d*)(\\D*)", "g"), u = new RegExp("(\\d*)(\\D*)", "g");
    do {
      var c = l.exec(i) || ["", "", ""], P = u.exec(a) || ["", "", ""];
  ...
  var s = new goog.asserts.AssertionError("" + n, g || []);
  ...
  for (var r = t.length, n = [], g = 0, s = goog.isString(t) ? t.split("") : t, i = 0; r > i; i++) if (i in s) {
    var a = s[i];
    o.call(e, a, i, t) && (n[g++] = a)
  }
  return n
  ...
  for (var r = t.length, n = new Array(r), g = goog.isString(t) ? t.split("") : t, s = 0; r > s; s++) s in g && (n[s] = o.call(e, g[s], s, t));
  return n
  ...
  for (var e = 1; e < arguments.length; e++) {
    var r, n = arguments[e];
    if (goog.isArray(n) || (r = goog.isArrayLike(n)) && Object.prototype.hasOwnProperty.call(n, "callee")) t.push.apply(t, n); else if (r) for (var g = t.length, s = n.length, i = 0; s > i; i++) t[g + i] = n[i]; else t.push(n)
  }
  ...
  }, g = e || n, s = {}, i = 0, a = 0; a < t.length;) {
    var l = t[a++], u = g(l);
    Object.prototype.hasOwnProperty.call(s, u) || (s[u] = !0, r[i++] = l)
  }
  r.length = i
  ...
  for (var g, s = 0, i = t.length; i > s;) {
    var a, l = s + i >> 1;
    a = e ? o.call(n, t[l], l, t) : o(r, t[l]), a > 0 ? s = l + 1 : (i = l, g = !a)
  }
  return g ? s : ~s
  ...
  var r = [], n = 0, g = t, s = e || 1;
  if (void 0 !== o && (n = t, g = o), 0 > s * (g - n)) return [];
  if (s > 0) for (var i = n; g > i; i += s) r.push(i); else for (var i = n; i > g; i += s) r.push(i);
  return r
  ...
  var g = t.toString(), s = this.listeners[g];
  s || (s = this.listeners[g] = [], this.typeCount_++);
  var i, a = goog.events.ListenerMap.findListenerIndex_(s, o, r, n);
  return a > -1 ? (i = s[a], e || (i.callOnce = !1)) : (i = new goog.events.Listener(o, null, this.src, g, !!r, n), i.callOnce = e, s.push(i)), i
},goog.events.ListenerMap.prototype.remove = function (t, o, e, r) {
  var n = t.toString();
  if (!(n in this.listeners)) return !1;
  var g = this.listeners[n], s = goog.events.ListenerMap.findListenerIndex_(g, o, e, r);
  if (s > -1) {
    var i = g[s];
    return i.markAsRemoved(), goog.array.removeAt(g, s), 0 == g.length && (delete this.listeners[n], this.typeCount_--), !0
  }
  return !1
  ...
  return goog.object.some(this.listeners, function (t, g) {
    for (var s = 0; s < t.length; ++s) if (!(e && t[s].type != r || n && t[s].capture != o)) return !0;
    return !1
  })
  ...
  i || (t[goog.events.LISTENER_MAP_PROP_] = i = new goog.events.ListenerMap(t));
  var a = i.add(o, e, r, n, g);
  if (a.proxy) return a;
  var l = goog.events.getProxy();
  return a.proxy = l, l.src = t, l.listener = a, t.addEventListener ? t.addEventListener(o.toString(), l, s) : t.attachEvent(goog.events.getOnString_(o.toString()), l), goog.events.listenerCountEstimate_++, a
  ...
  if (!t) return !1;
  var s = !!r, i = goog.events.getListenerMap_(t);
  if (i) {
    var a = i.getListener(o, e, s, n);
  ...
  for (var g in e.listeners) if (!n || g == n) for (var s = e.listeners[g].concat(), i = 0; i < s.length; ++i) goog.events.unlistenByKey(s[i]) && ++r;
  return r
  ...
  return s ? s.getListener(o, e, g, n) : null
  ...
  if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    ...
    if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
      if (!goog.events.isMarkedIeEvent_(e)) {
        ...
        for (var g = [], s = r.currentTarget; s; s = s.parentNode) g.push(s);
        for (var i = t.type, a = g.length - 1; !r.propagationStopped_ && a >= 0; a--) r.currentTarget = g[a], n &= goog.events.fireListeners_(g[a], i, !0, r);
        for (var a = 0; !r.propagationStopped_ && a < g.length; a++) r.currentTarget = g[a], n &= goog.events.fireListeners_(g[a], i, !1, r)
      }
...
"object" == typeof module && "object" == typeof module.exports ? module.exports = P : "function" == typeof define && define.amd && define(P), "undefined" != typeof window && expose(), P.Constants = {
  ...
  FITTING_COUNT: 100,
  ZERO_TOLERANCE: 1e-4
}, P.Utils = {_stampId: 0}, P.Utils.trim = function (t) {
  ...
  var n = this, g = P.DomUtils.getDomEventKey(o, e, r), s = t[g];
  return s ? n : (s = function (o) {
    return e.call(r || t, o)
  }, "addEventListener" in t ? t.addEventListener(o, s, !1) : "attachEvent" in t && t.attachEvent("on" + o, s), t[g] = s, n)
}, P.DomUtils.removeListener = function (t, o, e, r) {
  var n = this, g = P.DomUtils.getDomEventKey(o, e, r), s = t[g];
  return s ? ("removeEventListener" in t ? t.removeEventListener(o, s, !1) : "detachEvent" in t && t.detachEvent("on" + o, s), t[g] = null, n) : n
}, P.PlotTypes = {
  ARC: "arc",
  ELLIPSE: "ellipse",
  CURVE: "curve",
  ...
  var r = [(t[0] + o[0]) / 2, (t[1] + o[1]) / 2], n = [r[0] - t[1] + o[1], r[1] + t[0] - o[0]],
    g = [(t[0] + e[0]) / 2, (t[1] + e[1]) / 2], s = [g[0] - t[1] + e[1], g[1] + t[0] - e[0]];
  return P.PlotUtils.getIntersectPoint(r, n, g, s)
}, P.PlotUtils.getIntersectPoint = function (t, o, e, r) {
  if (t[1] == o[1]) {
    var n = (r[0] - e[0]) / (r[1] - e[1]), g = n * (t[1] - e[1]) + e[0], s = t[1];
    return [g, s]
  }
  if (e[1] == r[1]) {
    var i = (o[0] - t[0]) / (o[1] - t[1]);
    return g = i * (e[1] - t[1]) + t[0], s = e[1], [g, s]
  }
  return i = (o[0] - t[0]) / (o[1] - t[1]), n = (r[0] - e[0]) / (r[1] - e[1]), s = (i * t[1] - t[0] - n * e[1] + e[0]) / (i - n), g = i * s - i * t[1] + t[0], [g, s]
  ...
  var r = o[0] + t * (e[0] - o[0]), n = o[1] + t * (e[1] - o[1]);
  return [r, n]
}, P.PlotUtils.getCubicValue = function (t, o, e, r, n) {
  t = Math.max(Math.min(t, 1), 0);
  var g = 1 - t, s = t * t, i = s * t, a = g * g, l = a * g,
    u = l * o[0] + 3 * a * t * e[0] + 3 * g * s * r[0] + i * n[0],
    c = l * o[1] + 3 * a * t * e[1] + 3 * g * s * r[1] + i * n[1];
  return [u, c]
}, P.PlotUtils.getThirdPoint = function (t, o, e, r, n) {
  var g = P.PlotUtils.getAzimuth(t, o), s = n ? g + e : g - e, i = r * Math.cos(s), a = r * Math.sin(s);
  return [o[0] + i, o[1] + a]
}, P.PlotUtils.getArcPoints = function (t, o, e, r) {
  var n, g, s = [], i = r - e;
  i = 0 > i ? i + P.Constants.TWO_PI : i;
  for (var a = 0; a <= P.Constants.FITTING_COUNT; a++) {
    var l = e + i * a / P.Constants.FITTING_COUNT;
    n = t[0] + o * Math.cos(l), g = t[1] + o * Math.sin(l), s.push([n, g])
  }
  return s
}, P.PlotUtils.getBisectorNormals = function (t, o, e, r) {
  var n = P.PlotUtils.getNormal(o, e, r), g = Math.sqrt(n[0] * n[0] + n[1] * n[1]), s = n[0] / g, i = n[1] / g,
    a = P.PlotUtils.distance(o, e), l = P.PlotUtils.distance(e, r);
  if (g > P.Constants.ZERO_TOLERANCE) if (P.PlotUtils.isClockWise(o, e, r)) {
    var u = t * a, c = e[0] - u * i, p = e[1] + u * s, h = [c, p];
    u = t * l, c = e[0] + u * i, p = e[1] - u * s;
    var d = [c, p]
  } else u = t * a, c = e[0] + u * i, p = e[1] - u * s, h = [c, p], u = t * l, c = e[0] - u * i, p = e[1] + u * s, d = [c, p]; else c = e[0] + t * (o[0] - e[0]), p = e[1] + t * (o[1] - e[1]), h = [c, p], c = e[0] + t * (r[0] - e[0]), p = e[1] + t * (r[1] - e[1]), d = [c, p];
  return [h, d]
}, P.PlotUtils.getNormal = function (t, o, e) {
  var r = t[0] - o[0], n = t[1] - o[1], g = Math.sqrt(r * r + n * n);
  r /= g, n /= g;
  var s = e[0] - o[0], i = e[1] - o[1], a = Math.sqrt(s * s + i * i);
  s /= a, i /= a;
  var l = r + s, u = n + i;
  return [l, u]
}, P.PlotUtils.getCurvePoints = function (t, o) {
  for (var e = P.PlotUtils.getLeftMostControlPoint(o), r = [e], n = 0; n < o.length - 2; n++) {
    var g = o[n], s = o[n + 1], i = o[n + 2], a = P.PlotUtils.getBisectorNormals(t, g, s, i);
    r = r.concat(a)
  }
  ...
  for (n = 0; n < o.length - 1; n++) {
    g = o[n], s = o[n + 1], u.push(g);
    for (var t = 0; t < P.Constants.FITTING_COUNT; t++) {
      var c = P.PlotUtils.getCubicValue(t / P.Constants.FITTING_COUNT, g, r[2 * n], r[2 * n + 1], s);
      u.push(c)
    }
    u.push(s)
  }
  ...
  var e = o[0], r = o[1], n = o[2], g = P.PlotUtils.getBisectorNormals(0, e, r, n), s = g[0],
    i = P.PlotUtils.getNormal(e, r, n), a = Math.sqrt(i[0] * i[0] + i[1] * i[1]);
  if (a > P.Constants.ZERO_TOLERANCE) var l = P.PlotUtils.mid(e, r), u = e[0] - l[0], c = e[1] - l[1],
    p = P.PlotUtils.distance(e, r), h = 2 / p, d = -h * c, f = h * u, E = d * d - f * f, v = 2 * d * f,
    A = f * f - d * d, _ = s[0] - l[0], y = s[1] - l[1], m = l[0] + E * _ + v * y,
    O = l[1] + v * _ + A * y; else m = e[0] + t * (r[0] - e[0]), O = e[1] + t * (r[1] - e[1]);
  return [m, O]
}, P.PlotUtils.getRightMostControlPoint = function (o) {
  var e = o.length, r = o[e - 3], n = o[e - 2], g = o[e - 1], s = P.PlotUtils.getBisectorNormals(0, r, n, g), i = s[1],
    a = P.PlotUtils.getNormal(r, n, g), l = Math.sqrt(a[0] * a[0] + a[1] * a[1]);
  if (l > P.Constants.ZERO_TOLERANCE) var u = P.PlotUtils.mid(n, g), c = g[0] - u[0], p = g[1] - u[1],
    h = P.PlotUtils.distance(n, g), d = 2 / h, f = -d * p, E = d * c, v = f * f - E * E, A = 2 * f * E,
    _ = E * E - f * f, y = i[0] - u[0], m = i[1] - u[1], O = u[0] + v * y + A * m,
  ...
  for (var o = [], e = t.length - 1, r = 0; 1 >= r; r += .01) {
    for (var n = y = 0, g = 0; e >= g; g++) {
      var s = P.PlotUtils.getBinomialFactor(e, g), i = Math.pow(r, g), a = Math.pow(1 - r, e - g);
      n += s * i * a * t[g][0], y += s * i * a * t[g][1]
    }
    o.push([n, y])
  }
  return o.push(t[e]), o
  ...
  for (var n = 0; r >= n; n++) for (var g = 0; 1 >= g; g += .05) {
    for (var s = y = 0, i = 0; o >= i; i++) {
      var a = P.PlotUtils.getQuadricBSplineFactor(i, g);
      s += a * t[n + i][0], y += a * t[n + i][1]
    }
    e.push([s, y])
  }
  ...
  isPlot: function () {
    ...
    this.points = t ? t : [], this.points.length >= 2 && this.generate()
  }, getPoints: function () {
  ...
  if (!(2 > t)) if (2 == t) this.setCoordinates(this.points); else {
    var o = this.points[0], e = this.points[1], r = this.points[2],
      n = P.PlotUtils.getCircleCenterOfThreePoints(o, e, r), g = P.PlotUtils.distance(o, n),
      s = P.PlotUtils.getAzimuth(o, n), i = P.PlotUtils.getAzimuth(e, n);
    if (P.PlotUtils.isClockWise(o, e, r)) var a = i, l = s; else a = s, l = i;
  ...
  if (!(this.getPointCount() < 2)) {
    ...
    var t = this.getPoints(), o = t[0], e = t[1];
    P.PlotUtils.isClockWise(t[0], t[1], t[2]) && (o = t[1], e = t[0]);
    var r = P.PlotUtils.mid(o, e), n = [r].concat(t.slice(2)), g = this.getArrowHeadPoints(n, o, e), s = g[0], i = g[4],
      a = P.PlotUtils.distance(o, e) / P.PlotUtils.getBaseLength(n), l = this.getArrowBodyPoints(n, s, i, a),
      u = l.length, c = [o].concat(l.slice(0, u / 2));
    c.push(s);
    var p = [e].concat(l.slice(u / 2, u));
    p.push(i), c = P.PlotUtils.getQBSplinePoints(c), p = P.PlotUtils.getQBSplinePoints(p), this.setCoordinates([c.concat(g, p.reverse())])
  }
}, P.Plot.AttackArrow.prototype.getArrowHeadPoints = function (t, o, e) {
  var r = P.PlotUtils.getBaseLength(t), n = r * this.headHeightFactor, g = t[t.length - 1];
  r = P.PlotUtils.distance(g, t[t.length - 2]);
  var s = P.PlotUtils.distance(o, e);
  n > s * this.headTailFactor && (n = s * this.headTailFactor);
  var i = n * this.headWidthFactor, a = n * this.neckWidthFactor;
  n = n > r ? r : n;
  var l = n * this.neckHeightFactor, u = P.PlotUtils.getThirdPoint(t[t.length - 2], g, 0, n, !0),
    c = P.PlotUtils.getThirdPoint(t[t.length - 2], g, 0, l, !0),
    p = P.PlotUtils.getThirdPoint(g, u, P.Constants.HALF_PI, i, !1),
    h = P.PlotUtils.getThirdPoint(g, u, P.Constants.HALF_PI, i, !0),
  ...
  for (var n = P.PlotUtils.wholeDistance(t), g = P.PlotUtils.getBaseLength(t), s = g * r, i = P.PlotUtils.distance(o, e), a = (s - i) / 2, l = 0, u = [], c = [], p = 1; p < t.length - 1; p++) {
    var h = P.PlotUtils.getAngleOfThreePoints(t[p - 1], t[p], t[p + 1]) / 2;
    l += P.PlotUtils.distance(t[p - 1], t[p]);
    var d = (s / 2 - l / n * a) / Math.sin(h), f = P.PlotUtils.getThirdPoint(t[p - 1], t[p], Math.PI - h, d, !0),
      E = P.PlotUtils.getThirdPoint(t[p - 1], t[p], h, d, !1);
    u.push(f), c.push(E)
  }
  return u.concat(c)
}, P.Plot.SquadCombat = function (t) {
  goog.base(this, []), this.type = P.PlotTypes.SQUAD_COMBAT, this.headHeightFactor = .18, this.headWidthFactor = .3, this.neckHeightFactor = .85, this.neckWidthFactor = .15, this.tailWidthFactor = .1, this.setPoints(t)
}, goog.inherits(P.Plot.SquadCombat, P.Plot.AttackArrow), P.Plot.SquadCombat.prototype.generate = function () {
  var t = this.getPoints(), o = this.getTailPoints(t), e = this.getArrowHeadPoints(t, o[0], o[1]), r = e[0], n = e[4],
    g = this.getArrowBodyPoints(t, r, n, this.tailWidthFactor), s = g.length, i = [o[0]].concat(g.slice(0, s / 2));
  i.push(r);
  var a = [o[1]].concat(g.slice(s / 2, s));
  a.push(n), i = P.PlotUtils.getQBSplinePoints(i), a = P.PlotUtils.getQBSplinePoints(a), this.setCoordinates([i.concat(e, a.reverse())])
}, P.Plot.SquadCombat.prototype.getTailPoints = function (t) {
  var o = P.PlotUtils.getBaseLength(t), e = o * this.tailWidthFactor,
  ...
  P.PlotUtils.isClockWise(t[0], t[1], t[2]) && (o = t[1], e = t[0]);
  var r = P.PlotUtils.mid(o, e), n = [r].concat(t.slice(2)), g = this.getArrowHeadPoints(n, o, e), s = g[0], i = g[4],
    a = P.PlotUtils.distance(o, e), l = P.PlotUtils.getBaseLength(n),
    u = l * this.tailWidthFactor * this.swallowTailFactor;
  this.swallowTailPnt = P.PlotUtils.getThirdPoint(n[1], n[0], 0, u, !0);
  var c = a / l, p = this.getArrowBodyPoints(n, s, i, c), h = p.length, d = [o].concat(p.slice(0, h / 2));
  d.push(s);
  var f = [e].concat(p.slice(h / 2, h));
  f.push(i), d = P.PlotUtils.getQBSplinePoints(d), f = P.PlotUtils.getQBSplinePoints(f), this.setCoordinates([d.concat(g, f.reverse(), [this.swallowTailPnt, d[0]])])
  ...
  var t = this.getPoints(), o = this.getTailPoints(t), e = this.getArrowHeadPoints(t, o[0], o[2]), r = e[0], n = e[4],
    g = this.getArrowBodyPoints(t, r, n, this.tailWidthFactor), s = g.length, i = [o[0]].concat(g.slice(0, s / 2));
  i.push(r);
  var a = [o[2]].concat(g.slice(s / 2, s));
  a.push(n), i = P.PlotUtils.getQBSplinePoints(i), a = P.PlotUtils.getQBSplinePoints(a), this.setCoordinates([i.concat(e, a.reverse(), [o[1], i[0]])])
}, P.Plot.TailedSquadCombat.prototype.getTailPoints = function (t) {
  var o = P.PlotUtils.getBaseLength(t), e = o * this.tailWidthFactor,
    r = P.PlotUtils.getThirdPoint(t[1], t[0], P.Constants.HALF_PI, e, !1),
    n = P.PlotUtils.getThirdPoint(t[1], t[0], P.Constants.HALF_PI, e, !0), g = e * this.swallowTailFactor,
    s = P.PlotUtils.getThirdPoint(t[1], t[0], 0, g, !0);
  return [r, s, n]
  ...
  var t = this.points[0], o = P.PlotUtils.distance(t, this.points[1]);
  this.setCoordinates([this.generatePoints(t, o)])
}, P.Plot.Circle.prototype.generatePoints = function (t, o) {
  for (var e, r, n, g = [], s = 0; s <= P.Constants.FITTING_COUNT; s++) n = 2 * Math.PI * s / P.Constants.FITTING_COUNT, e = t[0] + o * Math.cos(n), r = t[1] + o * Math.sin(n), g.push([e, r]);
  return g
  ...
  if (2 == this.getPointCount()) this.setCoordinates([this.points]); else {
    var t = this.getPoints();
    t.push(t[0], t[1]);
    for (var o = [], e = 0; e < t.length - 2; e++) {
      var r = P.PlotUtils.getBisectorNormals(this.t, t[e], t[e + 1], t[e + 2]);
      o = o.concat(r)
    }
    var n = o.length;
    o = [o[n - 1]].concat(o.slice(0, n - 1));
    var g = [];
    for (e = 0; e < t.length - 2; e++) {
      var s = t[e], i = t[e + 1];
      g.push(s);
      for (var a = 0; a <= P.Constants.FITTING_COUNT; a++) {
        var l = P.PlotUtils.getCubicValue(a / P.Constants.FITTING_COUNT, s, o[2 * e], o[2 * e + 1], i);
        g.push(l)
      }
      g.push(i)
    }
  ...
  2 == this.getPointCount() ? this.setCoordinates(this.points) : this.setCoordinates(P.PlotUtils.getCurvePoints(this.t, this.points))
  ...
  if (2 == this.getPointCount()) return void this.setCoordinates([this.points]);
  var t = this.points[0], o = this.points[1], e = this.points[2], r = this.getPointCount();
  3 == r ? this.tempPoint4 = this.getTempPoint4(t, o, e) : this.tempPoint4 = this.points[3], 3 == r || 4 == r ? this.connPoint = P.PlotUtils.mid(t, o) : this.connPoint = this.points[4];
  var n, g;
  P.PlotUtils.isClockWise(t, o, e) ? (n = this.getArrowPoints(t, this.connPoint, this.tempPoint4, !1), g = this.getArrowPoints(this.connPoint, o, e, !0)) : (n = this.getArrowPoints(o, this.connPoint, e, !1), g = this.getArrowPoints(this.connPoint, t, this.tempPoint4, !0));
  var s = n.length, i = (s - 5) / 2, a = n.slice(0, i), l = n.slice(i, i + 5), u = n.slice(i + 5, s), c = g.slice(0, i),
    p = g.slice(i, i + 5), h = g.slice(i + 5, s);
  ...
  var n = P.PlotUtils.mid(t, o), g = P.PlotUtils.distance(n, e), s = P.PlotUtils.getThirdPoint(e, n, 0, .3 * g, !0),
    i = P.PlotUtils.getThirdPoint(e, n, 0, .5 * g, !0);
  s = P.PlotUtils.getThirdPoint(n, s, P.Constants.HALF_PI, g / 5, r), i = P.PlotUtils.getThirdPoint(n, i, P.Constants.HALF_PI, g / 4, r);
  var a = [n, s, i, e],
    l = this.getArrowHeadPoints(a, this.headHeightFactor, this.headWidthFactor, this.neckHeightFactor, this.neckWidthFactor),
    u = l[0], c = l[4], p = P.PlotUtils.distance(t, o) / P.PlotUtils.getBaseLength(a) / 2,
    h = this.getArrowBodyPoints(a, u, c, p), d = h.length, f = h.slice(0, d / 2), E = h.slice(d / 2, d);
  ...
  var r = P.PlotUtils.getBaseLength(t), n = r * this.headHeightFactor, g = t[t.length - 1],
    s = (P.PlotUtils.distance(o, e), n * this.headWidthFactor), i = n * this.neckWidthFactor,
    a = n * this.neckHeightFactor, l = P.PlotUtils.getThirdPoint(t[t.length - 2], g, 0, n, !0),
    u = P.PlotUtils.getThirdPoint(t[t.length - 2], g, 0, a, !0),
    c = P.PlotUtils.getThirdPoint(g, l, P.Constants.HALF_PI, s, !1),
    p = P.PlotUtils.getThirdPoint(g, l, P.Constants.HALF_PI, s, !0),
    h = P.PlotUtils.getThirdPoint(g, u, P.Constants.HALF_PI, i, !1),
    d = P.PlotUtils.getThirdPoint(g, u, P.Constants.HALF_PI, i, !0);
  return [h, c, g, p, d]
  ...
  var r, n, g, s, i = P.PlotUtils.mid(t, o), a = P.PlotUtils.distance(i, e),
    l = P.PlotUtils.getAngleOfThreePoints(t, i, e);
  return l < P.Constants.HALF_PI ? (n = a * Math.sin(l), g = a * Math.cos(l), s = P.PlotUtils.getThirdPoint(t, i, P.Constants.HALF_PI, n, !1), r = P.PlotUtils.getThirdPoint(i, s, P.Constants.HALF_PI, g, !0)) : l >= P.Constants.HALF_PI && l < Math.PI ? (n = a * Math.sin(Math.PI - l), g = a * Math.cos(Math.PI - l), s = P.PlotUtils.getThirdPoint(t, i, P.Constants.HALF_PI, n, !1), r = P.PlotUtils.getThirdPoint(i, s, P.Constants.HALF_PI, g, !1)) : l >= Math.PI && l < 1.5 * Math.PI ? (n = a * Math.sin(l - Math.PI), g = a * Math.cos(l - Math.PI), s = P.PlotUtils.getThirdPoint(t, i, P.Constants.HALF_PI, n, !0), r = P.PlotUtils.getThirdPoint(i, s, P.Constants.HALF_PI, g, !0)) : (n = a * Math.sin(2 * Math.PI - l), g = a * Math.cos(2 * Math.PI - l), s = P.PlotUtils.getThirdPoint(t, i, P.Constants.HALF_PI, n, !0), r = P.PlotUtils.getThirdPoint(i, s, P.Constants.HALF_PI, g, !1)), r
  ...
  if (!(this.getPointCount() < 2)) {
    var t = this.points[0], o = this.points[1], e = P.PlotUtils.mid(t, o), r = Math.abs((t[0] - o[0]) / 2),
      n = Math.abs((t[1] - o[1]) / 2);
    this.setCoordinates([this.generatePoints(e, r, n)])
  }
},P.Plot.Ellipse.prototype.generatePoints = function (t, o, e) {
  for (var r, n, g, s = [], i = 0; i <= P.Constants.FITTING_COUNT; i++) g = 2 * Math.PI * i / P.Constants.FITTING_COUNT, r = t[0] + o * Math.cos(g), n = t[1] + e * Math.sin(g), s.push([r, n]);
  return s
},P.Plot.FineArrow = function (t) {
  goog.base(this, []), this.type = P.PlotTypes.FINE_ARROW, this.tailWidthFactor = .15, this.neckWidthFactor = .2, this.headWidthFactor = .25, this.headAngle = Math.PI / 8.5, this.neckAngle = Math.PI / 13, this.fixPointCount = 2, this.setPoints(t)
  ...
  var t = this.getPoints(), o = t[0], e = t[1], r = P.PlotUtils.getBaseLength(t), n = r * this.tailWidthFactor,
    g = r * this.neckWidthFactor, s = r * this.headWidthFactor,
    i = P.PlotUtils.getThirdPoint(e, o, P.Constants.HALF_PI, n, !0),
    a = P.PlotUtils.getThirdPoint(e, o, P.Constants.HALF_PI, n, !1),
    l = P.PlotUtils.getThirdPoint(o, e, this.headAngle, s, !1),
    u = P.PlotUtils.getThirdPoint(o, e, this.headAngle, s, !0),
    c = P.PlotUtils.getThirdPoint(o, e, this.neckAngle, g, !1),
    p = P.PlotUtils.getThirdPoint(o, e, this.neckAngle, g, !0), h = [i, c, l, e, u, p, a];
  ...
  if (!(t.length < 2)) {
    if (2 == this.getPointCount()) {
      var o = P.PlotUtils.mid(t[0], t[1]), e = P.PlotUtils.distance(t[0], o) / .9,
    ...
    for (var n = [], g = 0; g < t.length - 2; g++) {
      var s = t[g], i = t[g + 1], a = t[g + 2], l = P.PlotUtils.getBisectorNormals(this.t, s, i, a);
      n = n.concat(l)
    }
    var u = n.length;
    ...
    for (g = 0; g < t.length - 2; g++) {
      s = t[g], i = t[g + 1], c.push(s);
      for (var p = 0; p <= P.Constants.FITTING_COUNT; p++) {
        var r = P.PlotUtils.getCubicValue(p / P.Constants.FITTING_COUNT, s, n[2 * g], n[2 * g + 1], i);
        c.push(r)
      }
      c.push(i)
    }
  ...
  if (!(this.getPointCount() < 2)) {
    var t = this.getPoints();
    if (2 == this.getPointCount()) {
      var o = P.PlotUtils.mid(t[0], t[1]), e = P.PlotUtils.distance(t[0], o),
        r = P.PlotUtils.getThirdPoint(t[0], o, P.Constants.HALF_PI, e);
      t.push(r)
    }
    var n = t[0], g = t[1], s = t[2], i = P.PlotUtils.getCircleCenterOfThreePoints(n, g, s),
      a = P.PlotUtils.distance(n, i), l = P.PlotUtils.getAzimuth(n, i), u = P.PlotUtils.getAzimuth(g, i);
    if (P.PlotUtils.isClockWise(n, g, s)) var c = u, p = l; else c = l, p = u;
    var t = P.PlotUtils.getArcPoints(i, a, c, p);
  ...
  if (!(this.getPointCount() < 2)) if (2 == this.getPointCount()) this.setCoordinates([this.points]); else {
    var t = this.getPoints(), o = t[0], e = t[1], r = t[2], n = P.PlotUtils.distance(e, o),
      g = P.PlotUtils.getAzimuth(e, o), s = P.PlotUtils.getAzimuth(r, o), i = P.PlotUtils.getArcPoints(o, n, g, s);
    i.push(o, i[0]), this.setCoordinates([i])
  }
  ...
  if (!(this.getPointCount() < 2)) {
    var t = this.getPoints(), o = t[0], e = t[1], r = P.PlotUtils.distance(o, e), n = r / this.arrowLengthScale;
    n = n > this.maxArrowLength ? this.maxArrowLength : n;
    var g = P.PlotUtils.getThirdPoint(o, e, Math.PI / 6, n, !1),
      s = P.PlotUtils.getThirdPoint(o, e, Math.PI / 6, n, !0);
    this.setCoordinates([o, e, g, e, s])
  }
  ...
  var o = new ol.style.Stroke({color: "#000000", width: 1.25}), e = new ol.style.Fill({color: "rgba(0,0,0,0.4)"});
  this.style = new ol.style.Style({
    fill: e,
    stroke: o
  }), this.featureSource = new ol.source.Vector, this.drawOverlay = new ol.layer.Vector({source: this.featureSource}), this.drawOverlay.setStyle(this.style), this.setMap(t)
  ...
  this.points.push(t.coordinate), this.plot = P.PlotFactory.createPlot(this.plotType, this.points, this.plotParams), this.feature = new ol.Feature(this.plot), this.featureSource.addFeature(this.feature), this.map.un("click", this.mapFirstClickHandler, this), this.map.on("click", this.mapNextClickHandler, this), this.plot.freehand || this.map.on("dblclick", this.mapDoubleClickHandler, this), goog.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.mapMouseMoveHandler, !1, this)
},P.PlotDraw.prototype.mapMouseMoveHandler = function (t) {
  var o = this.map.getCoordinateFromPixel([t.offsetX, t.offsetY]);
  if (!(P.PlotUtils.distance(o, this.points[this.points.length - 1]) < P.Constants.ZERO_TOLERANCE)) if (this.plot.freehand) this.points.push(o), this.plot.setPoints(this.points); else {
    var e = this.points.concat([o]);
    this.plot.setPoints(e)
  }
},P.PlotDraw.prototype.mapNextClickHandler = function (t) {
  if (!this.plot.freehand) {
    if (P.PlotUtils.distance(t.coordinate, this.points[this.points.length - 1]) < P.Constants.ZERO_TOLERANCE)
      return;
  }
  this.points.push(t.coordinate);
  this.plot.setPoints(this.points);
  if (this.plot.fixPointCount == this.plot.getPointCount()) {
    this.mapDoubleClickHandler(t);
    return;
  }
  if (this.plot.freehand) {
    this.mapDoubleClickHandler(t);
  ...
  if (this.map && this.activePlot) {
    ...
    if (t) for (var o = P.DomUtils.createHidden("div", t, this.Constants.HELPER_HIDDEN_DIV), e = this.getControlPoints(), r = 0; r < e.length; r++) {
  ...
  var e = this.getMapParentElement(), r = P.DomUtils.get(this.Constants.HELPER_HIDDEN_DIV);
  r && e && P.DomUtils.remove(r, e)
},P.PlotEdit.prototype.initControlPoints = function () {
  if (this.map) {
    this.controlPoints = [];
    for (var t = this.getControlPoints(), o = 0; o < t.length; o++) {
      var e = this.Constants.HELPER_CONTROL_POINT_DIV + "-" + o, r = P.DomUtils.get(e),
        n = new ol.Overlay({id: e, position: t[o], positioning: "center-center", element: r});
  ...
  if (this.activeControlPointId) {
    var e = this.activePlot.getGeometry(), r = this.elementTable[this.activeControlPointId];
    e.updatePoint(o, r);
  ...
  if (t && t instanceof ol.Feature && t != this.activePlot) {
    var o = t.getGeometry();
    t.isPlot && (this.deactivate(), this.activePlot = t, this.map.on("pointermove", this.plotMouseOverOutHandler, this), this.initHelperDom(), this.initControlPoints())
  }
},P.PlotEdit.prototype.getControlPoints = function () {
  if (!this.activePlot) return [];
  var t = this.activePlot;
  return t.getPoints()
  ...
  for (var o = t.coordinate, e = o[0] - this.startPoint[0], r = o[1] - this.startPoint[1], n = [], g = 0; g < this.ghostControlPoints.length; g++) {
    var s = this.ghostControlPoints[g], i = [s[0] + e, s[1] + r];
    n.push(i);
    var a = this.Constants.HELPER_CONTROL_POINT_DIV + "-" + g, l = this.map.getOverlayById(a);
    l.setPosition(i), l.setPositioning("center-center")
  }
