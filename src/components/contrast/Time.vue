            ...
            shortcuts: [
              {
                ...
                onClick: ($event) => {
                  let el1=document.getElementById("time1");
                  let ele2=document.getElementById("time2")
                  // if(e.classList.contains(".time-active")){
                  //   e.classList.remove(".time-active")
                  // }else {
                  //   e.classList.add(".time-active")
                  // }
                  console.log($event)
