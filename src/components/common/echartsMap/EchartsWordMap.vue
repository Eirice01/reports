  ...
  <div id="echarChina">
    <div id="echartsFech">
      ...
      <div class="echartsFechLeft">
        <div class="fechtable">
          <div class="fechtablebody" :class="iscutry ? 'half-h':'all-h'">
    ...
    watch:{
      worldMapData:{
        handler:function(){
          ...
          this.getWordData();
          let urls ="";
          let params2 =this.handleWordDataParams();
          console.log(params2,123)
          if(this.$route.query.type=='pop'){
            urls=URL.queryPopChartData;
          }else if(this.$route.query.type=="tour"){
            urls=URL.queryTourChartContrastData;
          }
          this.$refs["statisticsChart"].queryChartData(params2,urls);
        },
        deep:true
      }
    },
