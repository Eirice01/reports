      ...
      <div class="num-list">
        ...
        <div class="num-list-text">
          ...
          <span class="num-icon-val">
            <div class="num-middle">
              <div>
              <span v-text="showFlowNum ? '路过人口':'暂驻人口'"></span>
            </div>
              <div>
  ...
  import {URL} from "../../../api/urlsConfig"
    export default {
      ...
      //流入流出人口统计
        ...
        //非实时旅游模块下分，日，月切换调用
        tourChangeDataType(type,time){
          let times=new Date(time)
          let times1 = this.changeFormatDate(times,type)
          this.changTypeNum(times1)
          if(this.showFlowNum){
            this.enterOrOutNum(times1)
            this.tourKeyPople(times1)
          }
        ...
        changTypeNum(time){
          ...
          if(this.istype=="tours"){
            ...
            url=URL.queryDemographic;
            params={
              date:typeof(time)=='string' ? time.replace(/-/g,'') : time,
              code:this.areaCode
            }
          }
          this.$http.request({
