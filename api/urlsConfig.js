...
var DEBUG = {
 ...
 /* //获取人口行为特征占比统计
  queryChartData:contextPath+'/api/modules/population/chineseOtherCountry.json',*/
  //获取人口行为特征占比统计
  queryPopChartData:contextPath+'/api/modules/population/queryChartData.json',
  //获取旅游人口行为特征占比统计
  queryTourChartData:contextPath+'/api/modules/population/queryChartData.json',
 ...
 //点击省级获取市级地图数据
  ...
  //常驻，流动，游客人口数量边变化
  popNum:contextPath+'/api/modules/tour/popNum.json',
  //旅游页面非实时下日,月调用
 ...
 //旅游页面信息列表 来源地  归属地
  ...
  //报告删除/批量/单个
  deleteReport:contextPath+'/api/modules/report/deleteReport.json',

  //获取预览报告数据
  queryPreviewReportData:contextPath+'/api/modules/report/pt.json',
  //获取热力图数据
  reportSeeHeatMap:contextPath+'/api/modules/report/reportSeeHeatMap.json',

  //获取新增报告条件数据
  reportconditionslist:contextPath+'/api/modules/report/reportconditionslist.json',

  //报告条件展示数据
  queryShowConditions:contextPath+'/api/modules/report/queryShowConditions.json',
  ...
  exportWord:contextPath+'/api/modules/report/word.json',
 ...
 //角色管理新增角色
  ...
  querySysRoles:contextPath+'/api/modules/system/querySysRoles.json',
  ...
  /*****************************轨迹start*********************************/
  //获取轨迹人数变化
  popNumChange:contextPath+'/api/modules/trajectory/popNumChange.json',
  //获取轨迹距离分布
  distanceChange:contextPath+'/api/modules/trajectory/distanceChange.json',
  //获取轨迹时长分布
  durationChange:contextPath+'/api/modules/trajectory/durationChange.json',
  //获取总量刚需量列表数据
  queryTrafficDataAvg:contextPath+'/api/modules/trajectory/queryTrafficDataAvg.json',
  //获取轨迹页面右边滑块最大值/
  queryMaxPeopleCountByTime:contextPath+'/api/modules/trajectory/queryMaxPeopleCountByTime.json',
  //获取轨迹页面右边滑块条数最大值/
  rightCount:contextPath+'/api/modules/trajectory/rightCount.json',
  /*****************************轨迹end*********************************/
  //交通路网
  line:contextPath+'/api/modules/trajectory/line.json',
  lineCount:contextPath+'/api/modules/trajectory/lineCount.json',
  area:contextPath+'/api/modules/trajectory/area.json',
  oDData:contextPath+'/api/modules/trajectory/oDData.json',
  /*****************************交通start*********************************/
  //获取点击交通路线折线图数据
  queryTrafficTrends:contextPath+'/api/modules/traffic/queryTrafficTrends.json',
  //获取右侧滑块对应人数
  queryPercentTraffic:contextPath+'/api/modules/traffic/queryPercentTraffic.json',
  //获取交通页面右边滑块最大值/
  queryMaxCount:contextPath+'/api/modules/trajectory/queryMaxPeopleCountByTime.json',
...
var RELEASE = {
  ...
  /**************************************人口统计页面start**********************************************/
  //报告列表
  queryreportData:population_contextPath +'/report/queryReports.do',


  //报告删除/批量/单个
   deleteReport: population_contextPath +'/report/deleteReport.do',

  //获取新增报告条件数据
  reportconditionslist:population_contextPath+'/report/queryReportTerm.do',

  //报告条件展示数据
  queryShowConditions:population_contextPath+'report/queryShowConditions.do',

  //报告条件保存
  insertReportTerm:population_contextPath+'/report/insertReportTerm.do',
  ...
  //获取人口行为特征占比统计
  queryPopChartData:population_contextPath+'/people/population/chineseOtherCountry.do',
  //获取旅游人口行为特征占比统计
  queryTourChartData:population_contextPath+'/tourism/travel/chineseOtherCountry.do',
  queryTourChartContrastData:POPULATION_CONTEXTPATH+'/tourism/analysis/getLocalForeign.do',
  ...
  //常驻，流动，游客人口数量边变化
  popNum:population_contextPath+'/tourism/travel/typeRealtimeNum.do',
  /**************************************旅游页面页面end**********************************************/
  ...
  //重点人导入模板
  templatedownload:population_contextPath+' /emphasis/download.do',
  //导入
...
/*****************************系统管理start*********************************/
 ...
 //获取用户管理表格数据
  ...
  //角色名称重复校验
  querySysRoleName:POPULATION_CONTEXTPATH+'/permission/querySysRoleName.do',
  ...
  deleteSysRole:POPULATION_CONTEXTPATH+'/permission/deleteSysRole.do',
 ...
 //高级检索下热力图数据导出
  ...
  exportExcel:POPULATION_CONTEXTPATH+'/people/popAnalysis/exportExcel.do',

 /*****************************剪切板end*********************************/

 /*****************************报告start*********************************/
 //获取预览报告数据
 queryPreviewReportData:POPULATION_CONTEXTPATH+'/report/reportSee.do',
   //获取热力图数据
   reportSeeHeatMap:POPULATION_CONTEXTPATH+'/report/reportSeeHeatMap.do',

  exportWord:POPULATION_CONTEXTPATH+'/report/exportReport.do',
  exportWordReport:POPULATION_CONTEXTPATH+'/report/exportWord.do',
 /*****************************报告end*********************************/
  /*****************************轨迹start*********************************/
  //获取轨迹人数变化
  popNumChange:POPULATION_CONTEXTPATH+'/traffic/od/popNumChange.do',
  //获取轨迹距离分布
  distanceChange:POPULATION_CONTEXTPATH+'/traffic/od/distanceChange.do',
  //获取轨迹时长分布
  durationChange:POPULATION_CONTEXTPATH+'/traffic/od/durationChange.do',
  //获取总量刚需量列表数据
  queryTrafficDataAvg:POPULATION_CONTEXTPATH+'/traffic/od/queryTrafficDataAvg.do',
  //获取轨迹页面右边滑块最大值最小值/
  queryMaxPeopleCountByTime:POPULATION_CONTEXTPATH+'/traffic/od/queryMaxPeopleCountByTime.do',
  area:POPULATION_CONTEXTPATH+'/roadAndGrid/queryGridData.do',
  oDData:POPULATION_CONTEXTPATH+'/traffic/od/mapData.do',
  //获取轨迹页面右边滑块条数最大值/
  rightCount:POPULATION_CONTEXTPATH+'/traffic/od/rightCount.do',
  //交通路网
  line:POPULATION_CONTEXTPATH+'/roadAndGrid/queryRoadData.do',
  lineCount:POPULATION_CONTEXTPATH+'/traffic/queryPercentTraffic.do',
  /*****************************轨迹end*********************************/
  /*****************************交通start*********************************/
  //获取点击交通路线折线图数据
  queryTrafficTrends:POPULATION_CONTEXTPATH+'/traffic/queryTrafficTrends.do',
  //获取右侧滑块对应人数
  queryPercentTraffic:POPULATION_CONTEXTPATH+'/traffic/queryPercentTraffic.do',
  //获取交通页面右边滑块最大值/
  queryMaxCount:POPULATION_CONTEXTPATH+'/traffic/queryMaxCount.do',
